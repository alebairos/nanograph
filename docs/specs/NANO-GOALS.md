...
| G84 | Blind discovery on real upstream (reject nobody flagged) | #126 | n/a | **Partial** (G86 novel reject on `1200wd/bitcoinlib` CompactSize, severity low #127; G88 historical CVE repro proves vehicle credibility; maintained PyPI long-tail honest null; novel high-severity yield likely needs thin GitHub-only targets or next pinned repro from queue) |
