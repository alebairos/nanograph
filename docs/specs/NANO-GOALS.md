...
| G89 | Pin next historical repro from candidate queue | #126 | n/a | **Queued** (recommended: `rust-bitcoin/rust-bech32` pre-#274; queue in [`PROBE-GENERATOR-SPIKE.md`](PROBE-GENERATOR-SPIKE.md)) |
