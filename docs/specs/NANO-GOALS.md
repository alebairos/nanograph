...
| Stacked gates reduce live-agent retries | **Disproven (this task/model)** | G14 blind A/B: both arms 1 round, 1 exec; zero author errors; trigger NOT MET |
...
| G14 | Blind live falsification of retry-reduction claim | #35 | Done (trigger NOT MET) |
...
| #35 | G13 live-agent harness + G14 blind falsification |
