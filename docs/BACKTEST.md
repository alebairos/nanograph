...
G32 delivered the scored shortlist. G33 runs the credibility track first, then G34 runs the ICP track.
...
**G34 (wabt ICP, parked).** wabt `ReadU64Leb128`, parent `89582f5` to fix `f1f3d6d`, silent too-big-u64 LEB128 acceptance. Scored in `fixtures/fit-cases/wabt-leb128-u64.fit`. Revives after G33 proves the machinery on canon.
